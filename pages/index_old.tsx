      ...
      <section className={'mt-8'}>
        ...
        <li>
          ...
          <li>
            ...
            <div className={'timeline-content'}>
              <h3 className={'text-lg font-bold mt-8 underline underline-offset-1'}>
              <a className={'with-scrapbox'} href='https://scrapbox.io/shuya-t/Softbank_Summer_Internship' target="_blank" rel="noopener noreferrer">
          ...
          <li>
            ...
            <div className={'timeline-content'}>
              <h3 className={'text-lg font-bold mt-8 underline underline-offset-1'}>
                <a className={'with-scrapbox'} href='https://scrapbox.io/shuya-t/Future_Internship' target="_blank" rel="noopener noreferrer">
